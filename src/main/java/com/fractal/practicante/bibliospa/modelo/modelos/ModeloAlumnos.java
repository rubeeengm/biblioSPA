...
public class ModeloAlumnos implements OperacionObtener<Alumno>, OperacionObtenerTodos<Alumno> {
     ...
     */
    /*
    public boolean insertar(Connection conexion, Alumno alumno) throws SQLException{
        try{
     ...
     * BD.
     * @return Alumno cuyo ID es el solicitado y con todos sus atributos con su
     ...
     *
     * @param conexion Conexión a la base de datos que se utilizará.
     * @return ArrayList de objetos de tipo Alumno igual al número de Alumnos
     * registrados en la BD con todos sus datos.
     * @throws SQLException
     */
    @Override
